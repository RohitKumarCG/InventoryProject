...
--Developed by Pushpraj kaushik on 28/09/2019
 ...
 supplierID varchar(40) references RMA.supplier(supplierID) Not Null,
...
Create Table RMA.Rawmaterialorder
 ...
 RawMaterialOrderID    varchar(40), 
 foreign key (RawMaterialOrderID) references RMA.rawmaterialorder(RawMaterialOrderID), 
...
DistributorID varchar(40) references Prod.Distributor(DistributorID) ,
